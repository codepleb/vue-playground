  ...
  <div class="ui grid about">
    ...
    <div class="content">
      <p>SimpleCoinCap displays market cap rankings, price, details and more for the top
        ...
        <a href="https://vuejs.org/" target="_blank">Vue</a>, <a href="https://router.vuejs.org/en/" target="_blank">Vue
          Router</a>,
        <a href="https://vuex.vuejs.org/en/" target="_blank">Vuex</a>, and deployed on <a href="https://www.heroku.com/"
      ...
      <p>
        Cryptocurrency data obtained from the <a href="https://coinmarketcap.com/api/" target="_blank">Coinmarketcap
        API</a>.
        Cryptocurrency logo images obtained from the <a href="https://chasing-coins.com/api" target="_blank">Chasing
        Coins API</a>.
        Design loosely inspired by <a href="https://dribbble.com/shots/4375541-Crypto-Market" target="_blank">Mark
        Henry</a>.
